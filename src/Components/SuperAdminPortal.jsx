...
import {
  ...
  FaSpinner, FaUserCircle, FaStore, FaReceipt, FaHistory, FaLock, FaArrowUp, FaArrowDown,
  FaUnlock, FaKey, FaBars, FaHome, FaRunning, FaChartBar, FaFileContract, FaChartPie,
  FaTimesCircle, FaExchangeAlt, FaMoneyBillWave, FaCreditCard, FaHashtag, FaCalendarAlt
} from "react-icons/fa";
...
function SuperAdminPortal() {
  ...
  const renderAdminPage = () => {
    switch (activePage) {
      ...
      case 'transactions':
        return <TransactionsTable isAdminView={true} />;
      case 'users':
